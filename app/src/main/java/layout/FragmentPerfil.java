...
public class FragmentPerfil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Alumno alumno = new Alumno(123,"Juan Alberto", "Perez Gonzalez",  "0971123123");
        ...
        idAlumnoText.setText(Integer.toString(alumno.getIdAlumno()));
        TextView telefonoText = (TextView) view.findViewById(R.id.telefono);
